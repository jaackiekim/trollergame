...
public class TrollGameTest {
   ...
   @Before public void setUp() {
       ...
       seededGame2 = new TrollGame(123);//player can win.
   ...
   public void testMovePlayerMethod7()throws Exception {
      ...
      methodToExecute.invoke(seededGame2, new Object[]{"r"});
      methodToExecute.invoke(seededGame2, new Object[]{"r"});             
      if(!(gameBoard[7][9] instanceof Player))
         result = false; 
      assertEquals("Test 44: test movePlayer method- test that the player wins and occupys the treasure cell.", true, result);
   }
   ...
   public void testMovePlayerMethod8()throws Exception {
      ...
      methodToExecute.invoke(seededGame2, new Object[]{"r"});
      methodToExecute.invoke(seededGame2, new Object[]{"r"});
      boolean result = seededGame2.playerWins(); 
      assertEquals("Test 45: test movePlayer method- test the playerWins method.", true, result);
   }
